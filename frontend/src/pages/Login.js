...
function Login() {
    ...
    const handleSubmit = async (event) => {
        ...
        if (!result.success) {
            setError(result.error); //set the error
        }
    };
  ...
  return (
    <div className={styles.container}>
        <div className={styles.card}>
            ...
            <h2 className={styles.heading}>Sign in with email</h2>
            <p className={styles.subheading}>Use your email and password to login</p>
